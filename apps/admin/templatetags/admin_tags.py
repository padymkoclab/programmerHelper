...
@register.inclusion_tag('admin/admin/templatetags/display_bootstrap_fileinput.html')
...
@register.inclusion_tag('admin/admin/templatetags/display_date_hierarchy.html', takes_context=True)
...
@register.inclusion_tag('admin/admin/templatetags/display_fields.html')
...
def display_admin_filter(context, filter_):
    ...
    context.update(filter_.get_context(request))
