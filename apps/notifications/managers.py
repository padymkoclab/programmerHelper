...
class NotificationActivityManager(models.Manager):
    ...
    def get_queryset(self):
        ...
        qs = qs.filter(
            action__in=(
                Actions.ADDED_SNIPPET.value,
                Actions.ADDED_SOLUTION.value,
                Actions.ADDED_QUESTION.value,
                Actions.ADDED_ARTICLE.value,
                Actions.REGISTRED_USER.value,
                ...
                Actions.UPDATED_SOLUTION.value,
                Actions.UPDATED_QUESTION.value,
                Actions.UPDATED_SNIPPET.value,
                Actions.UPDATED_ARTICLE.value,
                ...
                Actions.DELETED_ARTICLE.value,
                Actions.DELETED_SOLUTION.value,
                Actions.DELETED_QUESTION.value,
                Actions.DELETED_SNIPPET.value,
