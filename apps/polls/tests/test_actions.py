...
class ActionsTests(EnhancedTestCase):
    ...
    def test_action_make_opened_no_one_polls(self):
        make_opened(self.ModelAdmin, self.mockrequest, Poll.objects.none())
    ...
    def test_action_make_opened_one_poll(self):
        make_opened(self.ModelAdmin, self.mockrequest, Poll.objects.filter(pk=self.poll6.pk))
    ...
    def test_action_make_opened_all_polls(self):
        make_opened(self.ModelAdmin, self.mockrequest, Poll.objects.all())
    ...
    def test_action_make_closed_no_one_polls(self):
        make_closed(self.ModelAdmin, self.mockrequest, Poll.objects.none())
    ...
    def test_action_make_closed_one_poll(self):
        make_closed(self.ModelAdmin, self.mockrequest, Poll.objects.filter(pk=self.poll1.pk))
    ...
    def test_action_make_closed_all_polls(self):
        make_closed(self.ModelAdmin, self.mockrequest, Poll.objects.all())
    ...
    def test_action_make_draft_no_one_polls(self):
        make_draft(self.ModelAdmin, self.mockrequest, Poll.objects.none())
    ...
    def test_action_make_draft_one_poll(self):
        make_draft(self.ModelAdmin, self.mockrequest, Poll.objects.filter(pk=self.poll1.pk))
    ...
    def test_action_make_draft_all_polls(self):
        make_draft(self.ModelAdmin, self.mockrequest, Poll.objects.all())
